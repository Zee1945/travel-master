                    ...
                    <div class="card card-details">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                    <td><img class="rounded-circle"
                                            src="https://ui-avatars.com/api/?name={{$detail->username}}" height="60" class="rounded-circle"></td>
                                    ...
                                    <td class="align-middle">
                                        <a href="{{ route('checkout-remove', $detail->id )}}"> <img src="{{url('frontend/img/icon/ic_delete.png')}}" alt=""
                                                width="14"></a>
                                    </td>
                                </tr>
                                 @empty
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method="POST" action="{{route('checkout-create', $item->id)}}">
                                ...
                                <input type="text" class="form-control mb-2 mr-sm-2" name="nationality"
                                ...
                                <select name="is_visa" id="is_visa" class="custom-select mb-2 mr-sm-2" required>
                                    <option value="" selected>VISA</option>N/A
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    <input type="text" name="doe_passport" id="doe_passport" class="form-control datepicker"
